$(window).load(function() {
    ...
    var public_spreadsheet_url = '1CZGURhDTUhvf2S8AtcZLFZk6UwRGk9QJkz11bJGT9s4';
    ...
    function getTable(data, tabletop) {
        ...
        $.each(tabletop.sheets(sheetname).all(), function(i, v) {
            ...
            $container.append('<div id="element-item"><div class="category">' + v.filtercategory + '</div><img src="' + v.piclink + '"><div class="name">' + v.title + '</div><div class="colorsubhed">' + v.subhed1 + '</div><div class="description">' + v.description + '</div><div class="colorsubhed2">' + v.subhed2 + '</div><div class="description">' + v.description2 + '</div></div>');
